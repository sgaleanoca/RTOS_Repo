...
(function() {
    ...
    function setFanMode(mode) {
        ...
        .then(data => {
            console.log(`[FAN] Modo cambiado a: ${mode}`);
            // Actualizar estado local
            fanState.currentMode = mode;
        ...
        .catch(err => {
            console.error('[FAN] Error al cambiar modo:', err);
        });
        ...
        .then(data => {
            console.log(`[FAN] Modo cambiado a: ${mode} (respuesta: ${data})`);
            fanState.currentMode = mode;
        })
        .catch(err => {
            console.error('[FAN] Error al cambiar modo:', err);
